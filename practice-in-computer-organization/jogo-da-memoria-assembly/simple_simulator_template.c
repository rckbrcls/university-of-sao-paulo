...
// nova instrucao
#define CMPB 23		// "010111"; -- CMPB Rx  		-- Compare Rx and 1 and set FR 	:  FL = <|zero|>		Format: < inst(6) | Rx(3) | xxxx | xxxx >
// nova instrucao
		...
		case STATE_DECODE:
			...
			switch(opcode){
				...
				case INC:
					...
					selM3 = rx;
					selM4 = 8;		// opcao 8 do mux4 deixa passar o nro 1
				...
				// nova instrucao
				case CMPB:		// comparar se rx é 1 (boolean)

					selM3 = rx;		// recupera o registrador x
					selM4 = 8;		// recupera o nro 1 no mux4
					OP = SUB;		// faz a sub ( rx - 1 )
					selM6 = sULA;	// seleciona o resultado da ULA
					
					LoadFR = 1;			// carrega as flags 	(VEREFICAR NECESSIDADE)
					// FR[3] = 0;		// seta o flag ZERO
